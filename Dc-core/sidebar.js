document.addEventListener("DOMContentLoaded", function () {
    ...
    const layoutHTML = `
        ...
        <aside class="sidebar" id="mainSidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="bids-pool.html" class="menu-item"><i class="fa-solid fa-layer-group"></i> <span>Bids Pool</span></a>
                ...
                <!-- 🔴 LOGOUT BUTTON -->
                <a href="javascript:void(0);" id="adminLogoutBtn" class="menu-item logout-item" style="color: #ff4d6d; margin-top: 15px; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 12px;">
                    <i class="fa-solid fa-right-from-bracket" style="color: #ff4d6d;"></i> 
    ...
    const menuLinks = document.querySelectorAll(".sidebar-menu .menu-item:not(.logout-item)");
    let pageFound = false;
    ...
    // 5. LOGOUT FUNCTIONALITY (Clears Session & Redirects to Login)
    const logoutBtn = document.getElementById("adminLogoutBtn");
    if (logoutBtn) {
        logoutBtn.addEventListener("click", function () {
            // Confirm popup if SweetAlert is present, else standard confirm
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    title: 'Logout Admin Panel?',
                    text: "You will need to login again to access panel.",
                    icon: 'warning',
    ...
    // =========================================================================
    // 6. SECURE & RELIABLE AUDIO & NOTIFICATION SYSTEM
    // =========================================================================
    ...
    // =========================================================================
    // 7. REALTIME CHAT MONITOR & SYSTEM PUSH NOTIFICATION (FIREBASE)
    // =========================================================================
